package com.example.milkshop.utils;
...
public class Utils {
    ...
    // public static final String BASE_URL="http://192.168.1.3/MilkShop/"; //link ip Quang Huy
//    public static final String BASE_URL="http://192.168.1.3/banhang/";
    ...
    public static List<GioHang> gioHangList; // Cach khac dung database
}
